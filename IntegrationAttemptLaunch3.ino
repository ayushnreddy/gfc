...
void checkSensors() {
  ...
  appendFile(SD, "/test.txt", dataToAppend.c_str());
  delay(50);
  ...
  if ((topAltitude - bmp.readAltitude(seapressure)) >= deploymentAltitudeDrop && !parachuteDeployed) {
