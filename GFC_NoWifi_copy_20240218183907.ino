...
Adafruit_BMP3XX bmp;
uint16_t measurement_delay_us = 1000000; // Delay between measurements for testing
...
// WIFI CODE
    ...
    std::string dataUpload = std::to_string(accel.acceleration.x) + ", " + std::to_string(accel.acceleration.y + 0.2) + ", " + std::to_string(accel.acceleration.z + 0.3) + ", " + std::to_string(gyro.gyro.x) + ", " + std::to_string(gyro.gyro.y) + ", " + std::to_string(gyro.gyro.z) + ", " + std::to_string(bmp.temperature) + ", " + std::to_string(bmp.pressure) + ", " + std::to_string(bmp.readAltitude(seapressure)) + "\n";
    appendFile(SD, "/Test.txt", dataUpload.c_str());
